...
parser.add_argument('--dropout1', default=0.5, type=float, help='dropout1')
parser.add_argument('--dropout2', default=0.5, type=float, help='dropout2')
...
parser.add_argument('--tcn_num', default=1 , type=int, help='')
...
def main():
    ...
    o = TCN(return_sequences=True, dropout_rate=args.dropout1)(i)
    if args.tcn_num >= 3:
